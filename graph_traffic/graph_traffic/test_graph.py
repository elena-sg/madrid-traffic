...
graph = get_graph(ubs, ubs_dict, weight_threshold=weight_threshold)[0]
plot_graph(graph, ids, save_dir=f"{figures_path}/test", graph_name="kamada-kawai-5", layout=nx.kamada_kawai_layout)

weight_threshold = 0.05
graph = get_graph(ubs, ubs_dict, weight_threshold=weight_threshold)[0]
plot_graph(graph, ids, save_dir=f"{figures_path}/test", graph_name="kamada-kawai-05", layout=nx.kamada_kawai_layout)